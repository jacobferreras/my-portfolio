...
const SkillsCard = (props: SkillsCardProps) => {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.95 }}
      className="card card-border bg-base-200 w-auto xl:w-100 lg:h-40 shadow-md shadow-blue-500/50 hover:shadow-lg transition-shadow duration-300 ease-in-out"
    >
      <div className="card-body">
        ...
        <div className="card-actions justify-start">
          <div className="badge badge-neutral ring-blue-300 ">
            {props.badge1}
          </div>
